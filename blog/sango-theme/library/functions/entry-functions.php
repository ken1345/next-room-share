  ...
  <div class="like_box">
    <div class="like_inside">
      <div class="like_img">
        ...
        ?>
        <img src="<?php echo $url; ?>" <?php sng_lazy_attr(); ?> width="520" height="300">
        <?php echo $title; ?>
      </div>
...
function sng_set_user_profile($bool) {
  ...
  <script>
    jQuery(function() {
      ...
      var removeButton = document.querySelector("#profile_bg_remove_btn");
      uploader.on('select', function() {
        var selections = uploader.state().get('selection');
        var selection = selections.single();
        var preview = document.querySelector("#profile_bg_preview");
        preview.style.display = 'block';
        preview.setAttribute('src', selection.attributes.url);
        var input = document.querySelector('#profile_bg');
      ...
      var button = document.querySelector("#profile_bg_btn");
...
if (!function_exists('output_sng_related_posts')) {
  ...
  <li>
    <a href="<?php echo get_permalink($related_post->ID); ?>">
      <figure class="rlmg">
        <img src="<?php echo $src; ?>" width="520" height="300" alt="<?php echo $title; ?>">
      </figure>
